...
config[:casper] = {
  blog: {
    ...
    name: 'Appcanary',
    description: '<a href="https://appcanary.com">Appcanary</a> makes sure you never run vulnerable software on your servers.<br/>Like our blog? Subscribe to our <a href="https://appcanary.us10.list-manage.com/subscribe?u=303b378f377508300c0b5469a&id=dc58e8f56f">newsletter</a>!',
    date_format: '%d %B %Y',
    navigation: false,
